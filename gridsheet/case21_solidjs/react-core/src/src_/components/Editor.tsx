import type { FC, KeyboardEvent } from "solid-js";
import { useContext, createEffect, createSignal, useCallback, memo } from "solid-js";
...
export const Editor: FC<Props> = ({ mode }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div class="gs-editor-inner" style={{ width }}>
        <pre
          class="gs-editor-hl"
          style={{
            //...cell?.style,
